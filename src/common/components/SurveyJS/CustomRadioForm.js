...
const CustomRadioForm = () => {
  ...
  const surveyJSON = {
    title: 'Testikysely',
    description: 'jotain description tekstiä tänne',
    pages: [
      {
        name: 'page1',
        title:
          'Ajattele tulevaa työuraasi valmistumisesi jälkeen, kuinka hyvin seuraavat asiat kuvaavat omia toiveitasi ja suunnitelmiasi.',
        questions: [
          {
            type: 'rating',
            name: 'satisfaction1',
            title:
              '1.	Kuinka todennäköistä on, että jatkat uraasi toisen palveluksessa (eli palkkatyössä) valmistumisesi jälkeen??',
          ...
          },
          {
            ...
            name: 'satisfaction2',
            title:
              '2.	Kuinka todennäköistä on, että tulet perustamaan oman yrityksen valmistumisesi jälkeen (tai opintojesi aikana)?',
            minRateDescription: 'erittäin epätodennäköistä',
            maxRateDescription: 'erittäin todennäköistä',
            isRequired: true
          },
          {
            ...
            name: 'satisfaction3',
            title:
              '3. Uskon, että läheisimmät perheenjäseneni ajattelevat, että minun 1 ei pitäisi … 7 pitäisi tavoitella oman yrityksen perustamista ja yrittäjänä toimimista valmistumiseni jälkeen.',
          ...
          },
          {
            ...
            name: 'satisfaction4',
            title:
              '4. Kuinka paljon välität siitä, mitä läheisimmät perheenjäsenesi ajattelevat, jos tavoittelet oman yrityksen perustamista ja yrittäjänä toimimista valmistumisesi jälkeen?',
        ...
        questions: [
          {
            type: 'matrixdropdown',
            name: 'KysymysRyhmä1',
            title: 'Ilmoita, oletko samaa vai eri mieltä seuraavista väitteistä',
            confirmDelete: false,
            columns: [
              {
                value: 1,
